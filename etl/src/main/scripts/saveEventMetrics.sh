...
if [ $? != 0 ]; then
    echo 1<&2 "ERROR: ${0}: Error occurred during save metrics for ${cur}"
...
if [ $? != 0 ]; then
    echo 1<&2 "ERROR: ${0}: Error occurred during save metrics"
