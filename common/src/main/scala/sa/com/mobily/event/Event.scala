...
import org.apache.spark.sql.catalyst.types.{LongType, ShortType, StringType, StructField}
...
object Event {
  ...
  /*  def getFields(): Seq[StructField]={
      Seq(StructField("beginTime",LongType,true),
        ...
        StructField("rat",ShortType,true),
        StructField("sac",StringType,true),
